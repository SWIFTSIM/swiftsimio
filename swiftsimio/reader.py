...
def generate_getter(
    ...
    def getter(self):
        ...
        if current_value is not None:
            ...
            with file_opener.open(filename, "r") as handle:
                try:
                    if mask is not None:
...
def generate_datasets(group_metadata: SWIFTGroupMetadata, file_opener, mask):
    """
...
class SWIFTDataset(object):
    ...
    def __init__(self, filename, file_opener, mask=None):
        """
    ...
    def get_units(self):
        ...
        self.units = SWIFTUnits(self.filename, self.file_opener)
